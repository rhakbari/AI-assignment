...
1. **Sign in** as `alice@ajaia.dev` (`password123`) — show the dashboard split into
   *My documents* and *Shared with me*.
2. **Create a document**, type a title, and use the toolbar (H1/H2, bold, italic,
